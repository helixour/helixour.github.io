(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const a of l)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(l){const a={};return l.integrity&&(a.integrity=l.integrity),l.referrerPolicy&&(a.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?a.credentials="include":l.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(l){if(l.ep)return;l.ep=!0;const a=n(l);fetch(l.href,a)}})();/*! (c) Andrea Giammarchi - ISC */var V={};try{V.WeakMap=WeakMap}catch{V.WeakMap=function(t,n){var s=n.defineProperty,l=n.hasOwnProperty,a=r.prototype;return a.delete=function(i){return this.has(i)&&delete i[this._]},a.get=function(i){return this.has(i)?i[this._]:void 0},a.has=function(i){return l.call(i,this._)},a.set=function(i,o){return s(i,this._,{configurable:!0,value:o}),this},r;function r(i){s(this,"_",{value:"_@ungap/weakmap"+t++}),i&&i.forEach(c,this)}function c(i){this.set(i[0],i[1])}}(Math.random(),Object)}const B=V.WeakMap;/*! (c) Andrea Giammarchi - ISC */var m="-"+Math.random().toFixed(6)+"%",N=!1;try{(function(e,t,n){return t in e&&(e.innerHTML="<p "+n+'="'+m+'"></p>',e[t].childNodes[0].getAttribute(n)==m)})(document.createElement("template"),"content","tabindex")||(m="_dt: "+m.slice(1,-1)+";",N=!0)}catch{}var Z="<!--"+m+"-->",i1=8,a1=1,c1=3,I=/^(?:plaintext|script|style|textarea|title|xmp)$/i,o1=/^(?:area|base|br|col|embed|hr|img|input|keygen|link|menuitem|meta|param|source|track|wbr)$/i;/*! (c) Andrea Giammarchi - ISC */function C1(e){return e.join(Z).replace(u1,g1).replace(f1,v1)}var S=" \\f\\n\\r\\t",U="[^"+S+`\\/>"'=]+`,O="["+S+"]+"+U,K="<([A-Za-z]+[A-Za-z0-9:._-]*)((?:",X=`(?:\\s*=\\s*(?:'[^']*?'|"[^"]*?"|<[^>]*?>|`+U.replace("\\/","")+"))?)",f1=new RegExp(K+O+X+"+)(["+S+"]*/?>)","g"),u1=new RegExp(K+O+X+"*)(["+S+"]*/>)","g"),h1=new RegExp("("+O+`\\s*=\\s*)(['"]?)`+Z+"\\2","gi");function v1(e,t,n,s){return"<"+t+n.replace(h1,p1)+s}function p1(e,t,n){return t+(n||'"')+m+(n||'"')}function g1(e,t,n){return o1.test(t)?e:"<"+t+n+"></"+t+">"}const{isArray:E}=Array,{indexOf:a2,slice:k}=[],$=e=>({get:t=>e.get(t),set:(t,n)=>(e.set(t,n),n)}),m1=1,Y=111,w1=({firstChild:e,lastChild:t})=>{const n=document.createRange();return n.setStartAfter(e),n.setEndAfter(t),n.deleteContents(),e},y=(e,t)=>e.nodeType===Y?1/t<0?t?w1(e):e.lastChild:t?e.valueOf():e.firstChild:e,d1=e=>{const{childNodes:t}=e,{length:n}=t;if(n<2)return n?t[0]:e;const s=k.call(t,0),l=s[0],a=s[n-1];return{ELEMENT_NODE:m1,nodeType:Y,firstChild:l,lastChild:a,valueOf(){if(t.length!==n){let r=0;for(;r<n;)e.appendChild(s[r++])}return e}}};/*! (c) Andrea Giammarchi - ISC */var J=function(e){var t="fragment",n="template",s="content"in r(n),l=s?function(i){var o=r(n);return o.innerHTML=i,o.content}:function(i){var o=r(t),C=r(n),u=null;if(/^[^\S]*?<(col(?:group)?|t(?:head|body|foot|r|d|h))/i.test(i)){var h=RegExp.$1;C.innerHTML="<table>"+i+"</table>",u=C.querySelectorAll(h)}else C.innerHTML=i,u=C.childNodes;return a(o,u),o};return function(o,C){return(C==="svg"?c:l)(o)};function a(i,o){for(var C=o.length;C--;)i.appendChild(o[0])}function r(i){return i===t?e.createDocumentFragment():e.createElementNS("http://www.w3.org/1999/xhtml",i)}function c(i){var o=r(t),C=r("div");return C.innerHTML='<svg xmlns="http://www.w3.org/2000/svg">'+i+"</svg>",a(o,C.firstChild.childNodes),o}}(document);const L=(e,t,n,s,l)=>{const a=n.length;let r=t.length,c=a,i=0,o=0,C=null;for(;i<r||o<c;)if(r===i){const u=c<a?o?s(n[o-1],-0).nextSibling:s(n[c-o],0):l;for(;o<c;)e.insertBefore(s(n[o++],1),u)}else if(c===o)for(;i<r;)(!C||!C.has(t[i]))&&e.removeChild(s(t[i],-1)),i++;else if(t[i]===n[o])i++,o++;else if(t[r-1]===n[c-1])r--,c--;else if(t[i]===n[c-1]&&n[o]===t[r-1]){const u=s(t[--r],-1).nextSibling;e.insertBefore(s(n[o++],1),s(t[i++],-1).nextSibling),e.insertBefore(s(n[--c],1),u),t[r]=n[c]}else{if(!C){C=new Map;let u=o;for(;u<c;)C.set(n[u],u++)}if(C.has(t[i])){const u=C.get(t[i]);if(o<u&&u<c){let h=i,p=1;for(;++h<r&&h<c&&C.get(t[h])===u+p;)p++;if(p>u-o){const v=s(t[i],0);for(;o<u;)e.insertBefore(s(n[o++],1),v)}else e.replaceChild(s(n[o++],1),s(t[i++],-1))}else i++}else e.removeChild(s(t[i++],-1))}return n};/*! (c) Andrea Giammarchi - ISC */var x1=function(e,t,n,s,l){var a=l in e,r=e.createDocumentFragment();r[t](e[s]("g")),r[t](e[s](""));var c=a?e[l](r,!0):r[n](!0);return c.childNodes.length<2?function i(o,C){for(var u=o[n](),h=o.childNodes||[],p=h.length,v=0;C&&v<p;v++)u[t](i(h[v],C));return u}:a?e[l]:function(i,o){return i[n](!!o)}}(document,"appendChild","cloneNode","createTextNode","importNode"),Q="".trim||function(){return String(this).replace(/^\s+|\s+/g,"")},b1=N?function(e,t){var n=t.join(" ");return t.slice.call(e,0).sort(function(s,l){return n.indexOf(s.name)<=n.indexOf(l.name)?-1:1})}:function(e,t){return t.slice.call(e,0)};function M1(e,t){for(var n=t.length,s=0;s<n;)e=e.childNodes[t[s++]];return e}function e1(e,t,n,s){for(var l=e.childNodes,a=l.length,r=0;r<a;){var c=l[r];switch(c.nodeType){case a1:var i=s.concat(r);y1(c,t,n,i),e1(c,t,n,i);break;case i1:var o=c.textContent;if(o===m)n.shift(),t.push(I.test(e.nodeName)?j(e,s):L1(c,s.concat(r)));else switch(o.slice(0,2)){case"/*":if(o.slice(-2)!=="*/")break;case"👻":e.removeChild(c),r--,a--}break;case c1:I.test(e.nodeName)&&Q.call(c.textContent)===Z&&(n.shift(),t.push(j(e,s)));break}r++}}function y1(e,t,n,s){for(var l=e.attributes,a=[],r=[],c=b1(l,n),i=c.length,o=0;o<i;){var C=c[o++],u=C.value===m,h;if(u||1<(h=C.value.split(Z)).length){var p=C.name;if(a.indexOf(p)<0){a.push(p);var v=n.shift().replace(u?/^(?:|[\S\s]*?\s)(\S+?)\s*=\s*('|")?$/:new RegExp("^(?:|[\\S\\s]*?\\s)("+p+`)\\s*=\\s*('|")[\\S\\s]*`,"i"),"$1"),d=l[v]||l[v.toLowerCase()];if(u)t.push(P(d,s,v,null));else{for(var x=h.length-2;x--;)n.shift();t.push(P(d,s,v,h))}}r.push(C)}}i=r.length,o=0;for(var H=0<i&&N&&!("ownerSVGElement"in e);o<i;){var w=r[o++];H&&(w.value=""),e.removeAttribute(w.name)}var b=e.nodeName;if(/^script$/i.test(b)){var M=document.createElement(b);for(i=l.length,o=0;o<i;)M.setAttributeNode(l[o++].cloneNode(!0));M.textContent=e.textContent,e.parentNode.replaceChild(M,e)}}function L1(e,t){return{type:"any",node:e,path:t}}function P(e,t,n,s){return{type:"attr",node:e,path:t,name:n,sparse:s}}function j(e,t){return{type:"text",node:e,path:t}}var F=$(new B);function k1(e,t){var n=(e.convert||C1)(t),s=e.transform;s&&(n=s(n));var l=J(n,e.type);t1(l);var a=[];return e1(l,a,t.slice(0),[]),{content:l,updates:function(r){for(var c=[],i=a.length,o=0,C=0;o<i;){var u=a[o++],h=M1(r,u.path);switch(u.type){case"any":c.push({fn:e.any(h,[]),sparse:!1});break;case"attr":var p=u.sparse,v=e.attribute(h,u.name,u.node);p===null?c.push({fn:v,sparse:!1}):(C+=p.length-2,c.push({fn:v,sparse:!0,values:p}));break;case"text":c.push({fn:e.text(h),sparse:!1}),h.textContent="";break}}return i+=C,function(){var d=arguments.length;if(i!==d-1)throw new Error(d-1+" values instead of "+i+`
`+t.join("${value}"));for(var x=1,H=1;x<d;){var w=c[x-H];if(w.sparse){var b=w.values,M=b[0],D=1,_=b.length;for(H+=_-2;D<_;)M+=arguments[x++]+b[D++];w.fn(M)}else w.fn(arguments[x++])}return r}}}}function T1(e,t){var n=F.get(t)||F.set(t,k1(e,t));return n.updates(x1.call(document,n.content,!0))}var H1=[];function E1(e){var t=H1,n=t1;return function(s){return t!==s&&(n=T1(e,t=s)),n.apply(null,arguments)}}function t1(e){for(var t=e.childNodes,n=t.length;n--;){var s=t[n];s.nodeType!==1&&Q.call(s.textContent).length===0&&e.removeChild(s)}}/*! (c) Andrea Giammarchi - ISC */var z1=function(){var e=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,t=/([^A-Z])([A-Z]+)/g;return function(c,i){return"ownerSVGElement"in c?s(c,i):a(c.style,!1)};function n(r,c,i){return c+"-"+i.toLowerCase()}function s(r,c){var i;return c?i=c.cloneNode(!0):(r.setAttribute("style","--hyper:style;"),i=r.getAttributeNode("style")),i.value="",r.setAttributeNode(i),a(i,!0)}function l(r){var c,i=[];for(c in r)i.push(c.replace(t,n),":",r[c],";");return i.join("")}function a(r,c){var i,o;return function(C){var u,h,p,v;switch(typeof C){case"object":if(C){if(i==="object"){if(!c&&o!==C)for(h in o)h in C||(r[h]="")}else c?r.value="":r.cssText="";u=c?{}:r;for(h in C)v=C[h],p=typeof v=="number"&&!e.test(h)?v+"px":v,!c&&/^--/.test(h)?u.setProperty(h,p):u[h]=p;i="object",c?r.value=l(o=u):o=C;break}default:o!=C&&(i="string",o=C,c?r.value=C||"":r.cssText=C||"");break}}}}();const Z1=e=>t=>{for(const n in t){const s=n==="role"?n:`aria-${n}`,l=t[n];l==null?e.removeAttribute(s):e.setAttribute(s,l)}},R=(e,t)=>{let n,s=!0;const l=document.createAttributeNS(null,t);return a=>{n!==a&&(n=a,n==null?s||(e.removeAttributeNode(l),s=!0):(l.value=a,s&&(e.setAttributeNodeNS(l),s=!1)))}},S1=(e,t,n)=>s=>{n!==!!s&&((n=!!s)?e.setAttribute(t,""):e.removeAttribute(t))},n1=({dataset:e})=>t=>{for(const n in t){const s=t[n];s==null?delete e[n]:e[n]=s}},A1=(e,t)=>{let n,s=t.slice(2);return!(t in e)&&t.toLowerCase()in e&&(s=s.toLowerCase()),l=>{const a=E(l)?l:[l,!1];n!==a[0]&&(n&&e.removeEventListener(s,n,a[1]),(n=a[0])&&e.addEventListener(s,n,a[1]))}},V1=e=>t=>{typeof t=="function"?t(e):t.current=e},q=(e,t)=>t==="dataset"?n1(e):n=>{e[t]=n},B1=(e,t)=>{let n;return s=>{n!==s&&(n=s,e[t]!==s&&(s==null?(e[t]="",e.removeAttribute(t)):e[t]=s))}},N1=/^(?:form|list)$/i,O1=(e,t)=>e.ownerDocument.createTextNode(t);function s1(e){return this.type=e,E1(this)}s1.prototype={attribute(e,t,n){const s=this.type==="svg";switch(t){case"class":if(s)return R(e,t);t="className";case"props":return q(e,t);case"aria":return Z1(e);case"style":return z1(e,n,s);case"ref":return V1(e);case".dataset":return n1(e);default:return t.slice(0,1)==="."?q(e,t.slice(1)):t.slice(0,1)==="?"?S1(e,t.slice(1)):t.slice(0,2)==="on"?A1(e,t):t in e&&!(s||N1.test(t))?B1(e,t):R(e,t)}},any(e,t){const{type:n}=this;let s=!1,l;const a=r=>{switch(typeof r){case"string":case"number":case"boolean":s?l!==r&&(l=r,t[0].textContent=r):(s=!0,l=r,t=L(e.parentNode,t,[O1(e,r)],y,e));break;case"function":a(r(e));break;case"object":case"undefined":if(r==null){s=!1,t=L(e.parentNode,t,[],y,e);break}default:if(s=!1,l=r,E(r))if(r.length===0)t.length&&(t=L(e.parentNode,t,[],y,e));else switch(typeof r[0]){case"string":case"number":case"boolean":a(String(r));break;case"function":a(r.map($1,e));break;case"object":E(r[0])&&(r=r.concat.apply([],r));default:t=L(e.parentNode,t,r,y,e);break}else"ELEMENT_NODE"in r?t=L(e.parentNode,t,r.nodeType===11?k.call(r.childNodes):[r],y,e):"text"in r?a(String(r.text)):"any"in r?a(r.any):"html"in r?t=L(e.parentNode,t,k.call(J([].concat(r.html).join(""),n).childNodes),y,e):"length"in r&&a(k.call(r));break}};return a},text(e){let t;const n=s=>{if(t!==s){t=s;const l=typeof s;l==="object"&&s?"text"in s?n(String(s.text)):"any"in s?n(s.any):"html"in s?n([].concat(s.html).join("")):"length"in s&&n(k.call(s).join("")):l==="function"?n(s(e)):e.textContent=s??""}};return n}};function $1(e){return e(this)}const{create:D1,freeze:_1,keys:c2}=Object,G=$(new B),I1=e=>({html:W("html",e),svg:W("svg",e),render(t,n){const s=typeof n=="function"?n():n,l=G.get(t)||G.set(t,T()),a=s instanceof A?z(e,l,s):s;return a!==l.wire&&(l.wire=a,t.textContent="",t.appendChild(a.valueOf())),t}}),T=()=>({stack:[],entry:null,wire:null}),W=(e,t)=>{const n=$(new B),s=a=>function(){return z(t,a,l.apply(null,arguments))};return l.for=(a,r)=>{const c=n.get(a)||n.set(a,D1(null));return c[r]||(c[r]=s(T()))},l.node=function(){return z(t,T(),l.apply(null,arguments)).valueOf()},l;function l(){return new A(e,j1.apply(null,arguments))}},z=(e,t,{type:n,template:s,values:l})=>{const{length:a}=l;r1(e,t,l,a);let{entry:r}=t;if(!r||r.template!==s||r.type!==n){const c=new e(n);t.entry=r={type:n,template:s,tag:c,wire:d1(c(s,...l))}}else r.tag(s,...l);return r.wire},r1=(e,{stack:t},n,s)=>{for(let l=0;l<s;l++){const a=n[l];a instanceof P1?n[l]=z(e,t[l]||(t[l]=T()),a):E(a)?r1(e,t[l]||(t[l]=T()),a,a.length):t[l]=null}s<t.length&&t.splice(s)};_1(A);function A(e,t){this.type=e,this.template=t.shift(),this.values=t}const P1=A,{render:o2,html:f,svg:C2}=I1(s1);function j1(){let e=[],t=0,{length:n}=arguments;for(;t<n;)e.push(arguments[t++]);return e}const F1="Shooting Spree",R1="",q1="Shooting Spree",G1="menu",W1="https://cdn.glitch.global/9f86fccc-25fa-4fde-afb8-43a451cb73b7/shootingspree.png?v=1744407407564",l1=[{url:"https://www.roblox.com/games/85359208907032/Shooting-Spree",text:"Play the game here!",img:"https://cdn.glitch.global/9f86fccc-25fa-4fde-afb8-43a451cb73b7/Overview-City-Templatesquare.png?v=1744407972181"},{url:"https://www.roblox.com/catalog/113301347470130/Shooting-Spree-T-Shirt",text:"Merch!",img:"https://cdn.glitch.global/9f86fccc-25fa-4fde-afb8-43a451cb73b7/ASDASDGSDFG.webp?v=1744426112646"}],U1={glitch:"",arena:"",bandcamp:"",bluesky:"",cohost:"",dev:"",facebook:"",github:"",gitlab:"",hashnode:"",instagram:"",keybase:"",kofi:"",letterboxd:"",linkedin:"",mastodon:"",medium:"",onlyfans:"",patreon:"",pinboard:"",pinterest:"",pixelfed:"",podcast:"",soundcloud:"",spotify:"",stackoverflow:"",substack:"",twitter:"",twitch:"",tiktok:"",tumblr:"",youtube:"",email:""},g={metaTitle:F1,metaDescription:R1,name:q1,theme:G1,avatarImage:W1,links:l1,social:U1},K1=f.node`
...
`,X1=f.node`<div>
  ...
  <h1>${g.name}</h1>
</div>`;function Y1(e){const t=e.url?e.url.replace(/[^a-z0-9]/gi,"-").toLowerCase():"";return f`
    <li class=${t}>
      <a href=${e.url}>
  ...
  `,Q1=f.node`<footer class="footer">`,e2={glitch:f`<svg
...
C213.484,200.108,212.476,198.418,210.857,197.545z"
  ...
  >
    <path
      ...
      fill="black"
    />
  </svg>`};function t2(e){if(g.social[e.name])return f`
      <a
    ...
    <div class="social-icons">
      ${n2.map(e=>f.node`${t2(e)}`)}
      ${void 0}
    </div>
  `,r2=document.getElementsByTagName("head")[0];r2.appendChild(K1);const l2=document.getElementById("content"),i2=[X1,J1,s2,Q1];i2.forEach(e=>l2.appendChild(e));
