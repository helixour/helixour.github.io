(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();/*! (c) Andrea Giammarchi - ISC */var B={};try{B.WeakMap=WeakMap}catch{B.WeakMap=function(t,n){var s=n.defineProperty,r=n.hasOwnProperty,i=l.prototype;return i.delete=function(a){return this.has(a)&&delete a[this._]},i.get=function(a){return this.has(a)?a[this._]:void 0},i.has=function(a){return r.call(a,this._)},i.set=function(a,o){return s(a,this._,{configurable:!0,value:o}),this},l;function l(a){s(this,"_",{value:"_@ungap/weakmap"+t++}),a&&a.forEach(c,this)}function c(a){this.set(a[0],a[1])}}(Math.random(),Object)}const N=B.WeakMap;/*! (c) Andrea Giammarchi - ISC */var m="-"+Math.random().toFixed(6)+"%",S=!1;try{(function(e,t,n){return t in e&&(e.innerHTML="<p "+n+'="'+m+'"></p>',e[t].childNodes[0].getAttribute(n)==m)})(document.createElement("template"),"content","tabindex")||(m="_dt: "+m.slice(1,-1)+";",S=!0)}catch{}var Z="<!--"+m+"-->",a1=8,i1=1,c1=3,I=/^(?:plaintext|script|style|textarea|title|xmp)$/i,o1=/^(?:area|base|br|col|embed|hr|img|input|keygen|link|menuitem|meta|param|source|track|wbr)$/i;/*! (c) Andrea Giammarchi - ISC */function C1(e){return e.join(Z).replace(u1,g1).replace(f1,v1)}var V=" \\f\\n\\r\\t",U="[^"+V+`\\/>"'=]+`,$="["+V+"]+"+U,K="<([A-Za-z]+[A-Za-z0-9:._-]*)((?:",X=`(?:\\s*=\\s*(?:'[^']*?'|"[^"]*?"|<[^>]*?>|`+U.replace("\\/","")+"))?)",f1=new RegExp(K+$+X+"+)(["+V+"]*/?>)","g"),u1=new RegExp(K+$+X+"*)(["+V+"]*/>)","g"),h1=new RegExp("("+$+`\\s*=\\s*)(['"]?)`+Z+"\\2","gi");function v1(e,t,n,s){return"<"+t+n.replace(h1,p1)+s}function p1(e,t,n){return t+(n||'"')+m+(n||'"')}function g1(e,t,n){return o1.test(t)?e:"<"+t+n+"></"+t+">"}const{isArray:E}=Array,{indexOf:i2,slice:k}=[],O=e=>({get:t=>e.get(t),set:(t,n)=>(e.set(t,n),n)}),m1=1,Y=111,w1=({firstChild:e,lastChild:t})=>{const n=document.createRange();return n.setStartAfter(e),n.setEndAfter(t),n.deleteContents(),e},y=(e,t)=>e.nodeType===Y?1/t<0?t?w1(e):e.lastChild:t?e.valueOf():e.firstChild:e,d1=e=>{const{childNodes:t}=e,{length:n}=t;if(n<2)return n?t[0]:e;const s=k.call(t,0),r=s[0],i=s[n-1];return{ELEMENT_NODE:m1,nodeType:Y,firstChild:r,lastChild:i,valueOf(){if(t.length!==n){let l=0;for(;l<n;)e.appendChild(s[l++])}return e}}};/*! (c) Andrea Giammarchi - ISC */var J=function(e){var t="fragment",n="template",s="content"in l(n),r=s?function(a){var o=l(n);return o.innerHTML=a,o.content}:function(a){var o=l(t),C=l(n),u=null;if(/^[^\S]*?<(col(?:group)?|t(?:head|body|foot|r|d|h))/i.test(a)){var h=RegExp.$1;C.innerHTML="<table>"+a+"</table>",u=C.querySelectorAll(h)}else C.innerHTML=a,u=C.childNodes;return i(o,u),o};return function(o,C){return(C==="svg"?c:r)(o)};function i(a,o){for(var C=o.length;C--;)a.appendChild(o[0])}function l(a){return a===t?e.createDocumentFragment():e.createElementNS("http://www.w3.org/1999/xhtml",a)}function c(a){var o=l(t),C=l("div");return C.innerHTML='<svg xmlns="http://www.w3.org/2000/svg">'+a+"</svg>",i(o,C.firstChild.childNodes),o}}(document);const L=(e,t,n,s,r)=>{const i=n.length;let l=t.length,c=i,a=0,o=0,C=null;for(;a<l||o<c;)if(l===a){const u=c<i?o?s(n[o-1],-0).nextSibling:s(n[c-o],0):r;for(;o<c;)e.insertBefore(s(n[o++],1),u)}else if(c===o)for(;a<l;)(!C||!C.has(t[a]))&&e.removeChild(s(t[a],-1)),a++;else if(t[a]===n[o])a++,o++;else if(t[l-1]===n[c-1])l--,c--;else if(t[a]===n[c-1]&&n[o]===t[l-1]){const u=s(t[--l],-1).nextSibling;e.insertBefore(s(n[o++],1),s(t[a++],-1).nextSibling),e.insertBefore(s(n[--c],1),u),t[l]=n[c]}else{if(!C){C=new Map;let u=o;for(;u<c;)C.set(n[u],u++)}if(C.has(t[a])){const u=C.get(t[a]);if(o<u&&u<c){let h=a,p=1;for(;++h<l&&h<c&&C.get(t[h])===u+p;)p++;if(p>u-o){const v=s(t[a],0);for(;o<u;)e.insertBefore(s(n[o++],1),v)}else e.replaceChild(s(n[o++],1),s(t[a++],-1))}else a++}else e.removeChild(s(t[a++],-1))}return n};/*! (c) Andrea Giammarchi - ISC */var x1=function(e,t,n,s,r){var i=r in e,l=e.createDocumentFragment();l[t](e[s]("g")),l[t](e[s](""));var c=i?e[r](l,!0):l[n](!0);return c.childNodes.length<2?function a(o,C){for(var u=o[n](),h=o.childNodes||[],p=h.length,v=0;C&&v<p;v++)u[t](a(h[v],C));return u}:i?e[r]:function(a,o){return a[n](!!o)}}(document,"appendChild","cloneNode","createTextNode","importNode"),Q="".trim||function(){return String(this).replace(/^\s+|\s+/g,"")},b1=S?function(e,t){var n=t.join(" ");return t.slice.call(e,0).sort(function(s,r){return n.indexOf(s.name)<=n.indexOf(r.name)?-1:1})}:function(e,t){return t.slice.call(e,0)};function M1(e,t){for(var n=t.length,s=0;s<n;)e=e.childNodes[t[s++]];return e}function e1(e,t,n,s){for(var r=e.childNodes,i=r.length,l=0;l<i;){var c=r[l];switch(c.nodeType){case i1:var a=s.concat(l);y1(c,t,n,a),e1(c,t,n,a);break;case a1:var o=c.textContent;if(o===m)n.shift(),t.push(I.test(e.nodeName)?j(e,s):L1(c,s.concat(l)));else switch(o.slice(0,2)){case"/*":if(o.slice(-2)!=="*/")break;case"👻":e.removeChild(c),l--,i--}break;case c1:I.test(e.nodeName)&&Q.call(c.textContent)===Z&&(n.shift(),t.push(j(e,s)));break}l++}}function y1(e,t,n,s){for(var r=e.attributes,i=[],l=[],c=b1(r,n),a=c.length,o=0;o<a;){var C=c[o++],u=C.value===m,h;if(u||1<(h=C.value.split(Z)).length){var p=C.name;if(i.indexOf(p)<0){i.push(p);var v=n.shift().replace(u?/^(?:|[\S\s]*?\s)(\S+?)\s*=\s*('|")?$/:new RegExp("^(?:|[\\S\\s]*?\\s)("+p+`)\\s*=\\s*('|")[\\S\\s]*`,"i"),"$1"),d=r[v]||r[v.toLowerCase()];if(u)t.push(P(d,s,v,null));else{for(var x=h.length-2;x--;)n.shift();t.push(P(d,s,v,h))}}l.push(C)}}a=l.length,o=0;for(var H=0<a&&S&&!("ownerSVGElement"in e);o<a;){var w=l[o++];H&&(w.value=""),e.removeAttribute(w.name)}var b=e.nodeName;if(/^script$/i.test(b)){var M=document.createElement(b);for(a=r.length,o=0;o<a;)M.setAttributeNode(r[o++].cloneNode(!0));M.textContent=e.textContent,e.parentNode.replaceChild(M,e)}}function L1(e,t){return{type:"any",node:e,path:t}}function P(e,t,n,s){return{type:"attr",node:e,path:t,name:n,sparse:s}}function j(e,t){return{type:"text",node:e,path:t}}var R=O(new N);function k1(e,t){var n=(e.convert||C1)(t),s=e.transform;s&&(n=s(n));var r=J(n,e.type);t1(r);var i=[];return e1(r,i,t.slice(0),[]),{content:r,updates:function(l){for(var c=[],a=i.length,o=0,C=0;o<a;){var u=i[o++],h=M1(l,u.path);switch(u.type){case"any":c.push({fn:e.any(h,[]),sparse:!1});break;case"attr":var p=u.sparse,v=e.attribute(h,u.name,u.node);p===null?c.push({fn:v,sparse:!1}):(C+=p.length-2,c.push({fn:v,sparse:!0,values:p}));break;case"text":c.push({fn:e.text(h),sparse:!1}),h.textContent="";break}}return a+=C,function(){var d=arguments.length;if(a!==d-1)throw new Error(d-1+" values instead of "+a+`
`+t.join("${value}"));for(var x=1,H=1;x<d;){var w=c[x-H];if(w.sparse){var b=w.values,M=b[0],D=1,_=b.length;for(H+=_-2;D<_;)M+=arguments[x++]+b[D++];w.fn(M)}else w.fn(arguments[x++])}return l}}}}function T1(e,t){var n=R.get(t)||R.set(t,k1(e,t));return n.updates(x1.call(document,n.content,!0))}var H1=[];function E1(e){var t=H1,n=t1;return function(s){return t!==s&&(n=T1(e,t=s)),n.apply(null,arguments)}}function t1(e){for(var t=e.childNodes,n=t.length;n--;){var s=t[n];s.nodeType!==1&&Q.call(s.textContent).length===0&&e.removeChild(s)}}/*! (c) Andrea Giammarchi - ISC */var z1=function(){var e=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,t=/([^A-Z])([A-Z]+)/g;return function(c,a){return"ownerSVGElement"in c?s(c,a):i(c.style,!1)};function n(l,c,a){return c+"-"+a.toLowerCase()}function s(l,c){var a;return c?a=c.cloneNode(!0):(l.setAttribute("style","--hyper:style;"),a=l.getAttributeNode("style")),a.value="",l.setAttributeNode(a),i(a,!0)}function r(l){var c,a=[];for(c in l)a.push(c.replace(t,n),":",l[c],";");return a.join("")}function i(l,c){var a,o;return function(C){var u,h,p,v;switch(typeof C){case"object":if(C){if(a==="object"){if(!c&&o!==C)for(h in o)h in C||(l[h]="")}else c?l.value="":l.cssText="";u=c?{}:l;for(h in C)v=C[h],p=typeof v=="number"&&!e.test(h)?v+"px":v,!c&&/^--/.test(h)?u.setProperty(h,p):u[h]=p;a="object",c?l.value=r(o=u):o=C;break}default:o!=C&&(a="string",o=C,c?l.value=C||"":l.cssText=C||"");break}}}}();const Z1=e=>t=>{for(const n in t){const s=n==="role"?n:`aria-${n}`,r=t[n];r==null?e.removeAttribute(s):e.setAttribute(s,r)}},F=(e,t)=>{let n,s=!0;const r=document.createAttributeNS(null,t);return i=>{n!==i&&(n=i,n==null?s||(e.removeAttributeNode(r),s=!0):(r.value=i,s&&(e.setAttributeNodeNS(r),s=!1)))}},V1=(e,t,n)=>s=>{n!==!!s&&((n=!!s)?e.setAttribute(t,""):e.removeAttribute(t))},n1=({dataset:e})=>t=>{for(const n in t){const s=t[n];s==null?delete e[n]:e[n]=s}},A1=(e,t)=>{let n,s=t.slice(2);return!(t in e)&&t.toLowerCase()in e&&(s=s.toLowerCase()),r=>{const i=E(r)?r:[r,!1];n!==i[0]&&(n&&e.removeEventListener(s,n,i[1]),(n=i[0])&&e.addEventListener(s,n,i[1]))}},B1=e=>t=>{typeof t=="function"?t(e):t.current=e},W=(e,t)=>t==="dataset"?n1(e):n=>{e[t]=n},N1=(e,t)=>{let n;return s=>{n!==s&&(n=s,e[t]!==s&&(s==null?(e[t]="",e.removeAttribute(t)):e[t]=s))}},S1=/^(?:form|list)$/i,$1=(e,t)=>e.ownerDocument.createTextNode(t);function s1(e){return this.type=e,E1(this)}s1.prototype={attribute(e,t,n){const s=this.type==="svg";switch(t){case"class":if(s)return F(e,t);t="className";case"props":return W(e,t);case"aria":return Z1(e);case"style":return z1(e,n,s);case"ref":return B1(e);case".dataset":return n1(e);default:return t.slice(0,1)==="."?W(e,t.slice(1)):t.slice(0,1)==="?"?V1(e,t.slice(1)):t.slice(0,2)==="on"?A1(e,t):t in e&&!(s||S1.test(t))?N1(e,t):F(e,t)}},any(e,t){const{type:n}=this;let s=!1,r;const i=l=>{switch(typeof l){case"string":case"number":case"boolean":s?r!==l&&(r=l,t[0].textContent=l):(s=!0,r=l,t=L(e.parentNode,t,[$1(e,l)],y,e));break;case"function":i(l(e));break;case"object":case"undefined":if(l==null){s=!1,t=L(e.parentNode,t,[],y,e);break}default:if(s=!1,r=l,E(l))if(l.length===0)t.length&&(t=L(e.parentNode,t,[],y,e));else switch(typeof l[0]){case"string":case"number":case"boolean":i(String(l));break;case"function":i(l.map(O1,e));break;case"object":E(l[0])&&(l=l.concat.apply([],l));default:t=L(e.parentNode,t,l,y,e);break}else"ELEMENT_NODE"in l?t=L(e.parentNode,t,l.nodeType===11?k.call(l.childNodes):[l],y,e):"text"in l?i(String(l.text)):"any"in l?i(l.any):"html"in l?t=L(e.parentNode,t,k.call(J([].concat(l.html).join(""),n).childNodes),y,e):"length"in l&&i(k.call(l));break}};return i},text(e){let t;const n=s=>{if(t!==s){t=s;const r=typeof s;r==="object"&&s?"text"in s?n(String(s.text)):"any"in s?n(s.any):"html"in s?n([].concat(s.html).join("")):"length"in s&&n(k.call(s).join("")):r==="function"?n(s(e)):e.textContent=s??""}};return n}};function O1(e){return e(this)}const{create:D1,freeze:_1,keys:c2}=Object,q=O(new N),I1=e=>({html:G("html",e),svg:G("svg",e),render(t,n){const s=typeof n=="function"?n():n,r=q.get(t)||q.set(t,T()),i=s instanceof A?z(e,r,s):s;return i!==r.wire&&(r.wire=i,t.textContent="",t.appendChild(i.valueOf())),t}}),T=()=>({stack:[],entry:null,wire:null}),G=(e,t)=>{const n=O(new N),s=i=>function(){return z(t,i,r.apply(null,arguments))};return r.for=(i,l)=>{const c=n.get(i)||n.set(i,D1(null));return c[l]||(c[l]=s(T()))},r.node=function(){return z(t,T(),r.apply(null,arguments)).valueOf()},r;function r(){return new A(e,j1.apply(null,arguments))}},z=(e,t,{type:n,template:s,values:r})=>{const{length:i}=r;l1(e,t,r,i);let{entry:l}=t;if(!l||l.template!==s||l.type!==n){const c=new e(n);t.entry=l={type:n,template:s,tag:c,wire:d1(c(s,...r))}}else l.tag(s,...r);return l.wire},l1=(e,{stack:t},n,s)=>{for(let r=0;r<s;r++){const i=n[r];i instanceof P1?n[r]=z(e,t[r]||(t[r]=T()),i):E(i)?l1(e,t[r]||(t[r]=T()),i,i.length):t[r]=null}s<t.length&&t.splice(s)};_1(A);function A(e,t){this.type=e,this.template=t.shift(),this.values=t}const P1=A,{render:o2,html:f,svg:C2}=I1(s1);function j1(){let e=[],t=0,{length:n}=arguments;for(;t<n;)e.push(arguments[t++]);return e}const R1="raccoon land",F1="This is the official Raccoon Land website!",W1="raccoon land",q1="menu",G1="https://cdn.glitch.global/b1ab9e01-2d01-41c8-a288-bb647105b10a/Raccoon%20land%20icon.png?v=1744208772227",r1=[{url:"https://www.roblox.com/games/16812227558/raccoon-land",text:"Play the game here!",img:"https://cdn.glitch.global/b1ab9e01-2d01-41c8-a288-bb647105b10a/raccoons.png?v=1744238778827"},{url:"https://www.roblox.com/catalog?Keyword=raccoon+land&Category=1&CreatorName=helixour%27s+games&salesTypeFilter=1",text:"Merch!",img:"https://cdn.glitch.global/b1ab9e01-2d01-41c8-a288-bb647105b10a/noFilter69.png?v=1744384964427"}],U1={glitch:"",arena:"",bandcamp:"",bluesky:"",cohost:"",dev:"",facebook:"",github:"",gitlab:"",hashnode:"",instagram:"",keybase:"",kofi:"",letterboxd:"",linkedin:"",mastodon:"",medium:"",onlyfans:"",patreon:"",pinboard:"",pinterest:"",pixelfed:"",podcast:"",soundcloud:"",spotify:"",stackoverflow:"",substack:"",twitter:"",twitch:"",tiktok:"",tumblr:"",youtube:"",email:""},g={metaTitle:R1,metaDescription:F1,name:W1,theme:q1,avatarImage:G1,links:r1,social:U1},K1=f.node`
...
`,X1=f.node`<div>
  ...
  `,Q1=f.node`<footer class="footer">`,e2={glitch:f`
